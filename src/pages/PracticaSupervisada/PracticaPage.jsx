...
import PublicacionesPracticaCard from '../../components/publicaciones/PublicacionesPracticaCard';
...
export const PracticaPage = () => {
  ...
  const [searchTerm, setSearchTerm] = useState("");
    ...
    .filter((publicacion) => publicacion.curso === "PRACTICA_SUPERVISADA")
    .filter((publicacion) =>
    ...
    <>
      ...
      <div className="taller-page-container">
        <div className="taller-header">
          <h1 className="taller-title">Publicaciones de Practica Supervisada</h1>
        </div>
